            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" id="descripcion" name="descripcion" 
                          placeholder="Ingrese la descripción del artículo" rows="3" required></textarea>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control" id="precio" name="precio" 
                         placeholder="Ingrese el precio"  min="0" maxlength="9999999" required>
                </div>
              </div>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <div class="custom-control custom-switch">
                  ...
                  <label class="custom-control-label" for="estado">Artículo Activo</label>
                </div>
              </div>
            </div>
          </div>
